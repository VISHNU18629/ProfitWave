...
function ProductsPage(){
    return(
      ...
      <LeftSection
        ...
        appStore=""
      />
      <p className="text-center mt-5 mb-5 fs-3 text-muted">
        <br/>
        <br/>
        Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>ProfitWave.tech</a> blog.
